  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-3xl mx-4 bg-[#16191f] border border-white/[0.1] rounded-xl shadow-2xl flex flex-col max-h-[85vh]">
        ...
        {/* Table header */}
        <div className="grid px-6 py-2 border-b border-white/[0.07] flex-shrink-0 bg-[#0e1014]"
        ...
        <div className="flex-1 overflow-y-auto px-6 py-3 space-y-1.5">
          ...
          {!loading && error && (
            <div className="flex flex-col items-center justify-center py-16 text-center">
              ...
              <button onClick={fetchLogs} className="mt-3 text-[11px] text-blue-400 border border-blue-500/30 px-4 py-1.5 rounded hover:bg-blue-500/10 transition-colors">
                Try again
              </button>
            </div>
          )}
          ...
          {!loading && !error && logs.map((log) => (
            ...
            >
              ...
              <span className={log.sucess ? 'text-emerald-400' : 'text-red-400'}>
                {log.statusCode}
              </span>
