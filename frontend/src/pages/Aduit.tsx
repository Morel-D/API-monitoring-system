    ...
    <div className="flex flex-col h-full overflow-hidden">
      ...
      <header className="flex items-center justify-between px-6 py-3.5 bg-[#16191f] border-b border-white/[0.07] flex-shrink-0">
        <div>
          ...
          <p className="text-[11px] text-[#6b7280]">Track all actions performed in the system</p>
        </div>
        <button
          type="button"
          onClick={fetchAll}
      ...
      <div className="flex-1 overflow-y-auto px-6 py-4">
        ...
        {/* Column headers */}
        {filtered.length > 0 && (
          <div className="grid px-4 mb-2 gap-4" style={{ gridTemplateColumns: '1fr 160px 180px 100px 40px' }}>
            {['User', 'Action', 'Description', 'Date', ''].map((h) => (
          ...
          <div className="space-y-1.5">
            {filtered.map((log) => (
              <div
                ...
                style={{ gridTemplateColumns: '1fr 160px 180px 100px 40px' }}
